...
// [outvideo] card-sc-crash-zoom-punch —— 移植自 video-shotcraft/demos/camera/crash-zoom-punch
...
const Scene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#f9f6f1', overflow: 'hidden' }}>
      ...
      >
        <Img src={staticFile(String(((__INJ__.CONFIG as any)?.image_1) ?? 'textures/live/projects-full.png'))} style={{ position: 'absolute', width: 1920 }} />
        <Img
          src={staticFile(String(((__INJ__.CONFIG as any)?.image_2) ?? 'textures/live/card4-hires.png'))}
          style={{
            position: 'absolute',
...
export default CrashImpactReal;
