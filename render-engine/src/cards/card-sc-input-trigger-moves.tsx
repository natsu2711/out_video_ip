// [outvideo] card-sc-input-trigger-moves —— 移植自 video-shotcraft/demos/interaction/input-trigger-moves
...
import { G, Card, FakeDashboard } from './_sc/Fixtures';
  ...
  return (
    <div style={{
      ...
      {fly.panel
        ...
        : <Card slot={0} w={fly.w} h={fly.h} seed={fly.seed}
