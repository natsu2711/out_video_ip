...
// [outvideo] card-sc-type-and-filter —— 移植自 video-shotcraft/demos/interaction/type-and-filter
...
const PAPER = '#f9f6f1';
const FIELD = '#fefcf9';
const AMBER = ((__INJ__.TEXT as string[])?.[0] ?? 'oklch(58% 0.13 65)');
const QUERY = ((__INJ__.TEXT2 as string[])?.[0] ?? 'nano-lab');
...
const NANO_TITLE = ((__INJ__.TEXT3 as string[])?.[0] ?? 'nano-lab');
