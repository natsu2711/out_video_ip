// [outvideo] card-sc-product-card-progressive-assemble —— 移植自 video-shotcraft/demos/ui-entrance/product-card-progressive-assemble
...
const ACCENT = '#ff6a1f';
const ACCENT_SOFT = ((__INJ__.TEXT as string[])?.[0] ?? 'rgba(255,122,26,.42)');
...
export default ProductCardProgressiveAssemble;
