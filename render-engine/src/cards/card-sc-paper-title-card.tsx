// [outvideo] card-sc-paper-title-card —— 移植自 video-shotcraft/demos/typography/paper-title-card
...
const SUB = ((__INJ__.TEXT3 as string[])?.[0] ?? 'of 31 fetched today');
const SUB_DIGITS = '5';
