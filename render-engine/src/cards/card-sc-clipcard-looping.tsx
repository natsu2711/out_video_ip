// [outvideo] card-sc-clipcard-looping —— 移植自 video-shotcraft/demos/ui-entrance/clipcard-looping
...
const CLIP = ((__INJ__.TEXT as string[])?.[0] ?? 'clips/clipcard-demo.mp4');
...
export default ClipCardLooping;
