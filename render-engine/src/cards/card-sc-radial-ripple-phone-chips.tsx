// [outvideo] card-sc-radial-ripple-phone-chips —— 移植自 video-shotcraft/demos/effects/radial-ripple-phone-chips
...
const RCOL = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['#d7dbe1', '#e0e4e9', '#e8ebef', '#eef0f3']) as string[];
...
export default RadialRipplePhoneChips;
