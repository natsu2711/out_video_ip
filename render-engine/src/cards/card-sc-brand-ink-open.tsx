...
// [outvideo] card-sc-brand-ink-open —— 移植自 video-shotcraft/demos/typography/brand-ink-open
...
const INK = ((__INJ__.TEXT3 as string[])?.[0] ?? 'oklch(18% 0.006 82)');
