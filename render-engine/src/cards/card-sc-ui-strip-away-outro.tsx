// [outvideo] card-sc-ui-strip-away-outro —— 移植自 video-shotcraft/demos/outro/ui-strip-away-outro
        ...
        {[0, 1, 2, 3].map((i) => {
          ...
          return (
            <div key={i} style={{ position: 'absolute', left: 70 + (i % 2) * 560, top: 120 + Math.floor(i / 2) * 340, ...s }}>
              <Card slot={0} w={480} h={280} seed={i + 2} />
            </div>
          );
        })}
      </div>
...
export default UiStripAwayOutro;
