// [outvideo] card-sc-cursor-flyover —— 移植自 video-shotcraft/demos/camera/cursor-flyover
...
const KEY = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['tx', 'ty', 's', 'cx', 'cy']) as string[];
