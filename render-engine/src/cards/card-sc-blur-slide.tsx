// [outvideo] card-sc-blur-slide —— 移植自 video-shotcraft/demos/typography/blur-slide
...
const H1_WORDS = (((__INJ__.TEXT as string[])?.[0] ?? 'Your headline goes here').split(' '));
const H2_WORDS = (((__INJ__.TEXT2 as string[])?.[0] ?? 'Short supporting subtitle for placeholders').split(' '));
