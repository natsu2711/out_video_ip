// [outvideo] card-sc-outline-word-fill —— 移植自 video-shotcraft/demos/typography/outline-word-fill
...
const WORD = (__INJ__.TEXT as string[])?.[0] ?? 'Faster';
...
export default OutlineWordFill;
