// [outvideo] card-sc-platform-hinge-rise —— 移植自 video-shotcraft/demos/ui-entrance/platform-hinge-rise
...
const SUBJECT_TXT = ((__INJ__.TEXT as string[])?.[0] ?? 'SUBJECT');
const CONTEXT_TXT = ((__INJ__.TEXT2 as string[])?.[0] ?? 'CONTEXT');
const OUTCOME_TXT = ((__INJ__.TEXT3 as string[])?.[0] ?? 'OUTCOME');
...
export default PlatformHingeRise;
