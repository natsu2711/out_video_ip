// [outvideo] card-sc-dataviz-landscape-open —— 移植自 video-shotcraft/demos/opening/dataviz-landscape-open
...
const LABEL_IDS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : LABELS.map((l) => l.id));
    ...
    <AbsoluteFill style={{backgroundColor: '#050505', overflow: 'hidden'}}>
      ...
      <AbsoluteFill style={{transform: `scale(${zoom})`, transformOrigin: '50% 50%'}}>
        ...
        <div style={layerStyle(midX)}>
          ...
          {LABELS.map((l, li) => {
            const labelId = LABEL_IDS[li] ?? l.id;
