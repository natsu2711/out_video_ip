// [outvideo] card-sc-scramble —— 移植自 video-shotcraft/demos/typography/scramble
...
import { DesignStage, rand, seg, useT } from './_sc/Motion';

export const SCRAMBLE_DURATION = 96; // 3200ms @30fps

const TEXT = ((__INJ__.TEXT as string[])?.[0] ?? 'TEMPLATE MOTION DEMO');
const POOL = ((__INJ__.TEXT2 as string[])?.[0] ?? 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789#$%&*+=<>/\\');
const CHARS = [...TEXT];
