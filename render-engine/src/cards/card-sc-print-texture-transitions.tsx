...
// [outvideo] card-sc-print-texture-transitions —— 移植自 video-shotcraft/demos/transition/print-texture-transitions
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', inset: 0, background: G.bg, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "BEFORE")} size={120} />
      </div>
