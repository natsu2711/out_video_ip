// [outvideo] card-sc-bottom-push-stack-wipe —— 移植自 video-shotcraft/demos/transition/bottom-push-stack-wipe
...
import { Card, G } from './_sc/Fixtures';
  ...
  return (
    <AbsoluteFill style={{ background: c.color, justifyContent: 'center', alignItems: 'center' }}>
      ...
      <div style={{ boxShadow: '0 30px 80px rgba(0,0,0,0.28)', borderRadius: 18 }}>
        ...
        <Card slot={0} w={860} h={430} seed={chapter + 2} style={{ borderRadius: '0 0 18px 18px', padding: 34 }} />
      </div>
    </AbsoluteFill>
  );
};
...
export default BottomPushStackWipe;
