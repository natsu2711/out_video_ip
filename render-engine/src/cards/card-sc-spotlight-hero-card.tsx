...
// [outvideo] card-sc-spotlight-hero-card —— 移植自 video-shotcraft/demos/opening/spotlight-hero-card
...
const INK = ((__INJ__.TEXT2 as string[])?.[0] ?? 'oklch(18% 0.006 82)');
const AMBER = ((__INJ__.TEXT3 as string[])?.[0] ?? 'oklch(52% 0.115 65)');
...
export default SpotlightHeroCard;
