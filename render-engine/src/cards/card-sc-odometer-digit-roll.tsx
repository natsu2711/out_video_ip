// [outvideo] card-sc-odometer-digit-roll —— 移植自 video-shotcraft/demos/data/odometer-digit-roll
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', left: 120, top: 96 }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "ODOMETER DIGIT ROLL")} size={54} />
      </div>
      <div
        style={{
          position: 'absolute',
...
export default OdometerDigitRoll;
