// [outvideo] card-sc-montage-rhythm-moves —— 移植自 video-shotcraft/demos/rhythm/montage-rhythm-moves
...
// 文字槽：TEXT = 结果大数字（默认 1）；TEXT2 = 翻牌目标数字（默认 1）
const RESULT_DIGIT = (__INJ__.TEXT as string[])?.[0] ?? '1';
const FLIP_TO = (__INJ__.TEXT2 as string[])?.[0] ?? '1';
...
export default WrightTripleCut;
