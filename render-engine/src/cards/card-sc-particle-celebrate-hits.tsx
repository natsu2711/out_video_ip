// [outvideo] card-sc-particle-celebrate-hits —— 移植自 video-shotcraft/demos/data/particle-celebrate-hits
...
import { G, TitleBlock } from './_sc/Fixtures';
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: 110, width: '100%', textAlign: 'center' }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "CONFETTI CROSSFIRE")} size={72} />
      </div>
...
export default ConfettiCrossfire;
