// [outvideo] card-sc-ai-stream-response —— 移植自 video-shotcraft/demos/interaction/ai-stream-response
...
import {
  ...
  Img,
  interpolate,
  useCurrentFrame, staticFile } from 'remotion';
const backplate = staticFile(String(((__INJ__.CONFIG as any)?.image_1) ?? '_sc_assets/agent-stream.jpg'));
