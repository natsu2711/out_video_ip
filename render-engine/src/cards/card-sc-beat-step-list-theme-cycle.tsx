// [outvideo] card-sc-beat-step-list-theme-cycle —— 移植自 video-shotcraft/demos/rhythm/beat-step-list-theme-cycle
...
const ROW_H = 150;
const WORDS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['modern', 'playful', 'expressive', 'seamless', 'intuitive']) as string[];
...
export default BeatStepListThemeCycle;
