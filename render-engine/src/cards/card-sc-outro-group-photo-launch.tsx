...
// [outvideo] card-sc-outro-group-photo-launch —— 移植自 video-shotcraft/demos/outro/outro-group-photo-launch
...
import { PageCam2D } from './_sc/PageCam2D';
import layout from '../../_textures/live-layout.json';

export const OUTRO_GROUP_PHOTO_LAUNCH_DURATION = 145;

const SERIF = ((__INJ__.TEXT as string[])?.[0] ?? 'ui-serif, Georgia, "Times New Roman", serif');
const MONO = ((__INJ__.TEXT2 as string[])?.[0] ?? 'ui-monospace, SFMono-Regular, Menlo, monospace');
const LETTERS = (((__INJ__.TEXT3 as string[])?.[0] ?? 'AI Foundation Lab').split(''));
...
export default OutroGroupPhotoLaunch;
