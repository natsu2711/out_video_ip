// [outvideo] card-sc-svg-shape-morph —— 移植自 video-shotcraft/demos/ui-entrance/svg-shape-morph
...
const LBL_A = ((__INJ__.TEXT as string[])?.[0] ?? 'morphTo(shapeA)');
const LBL_B = ((__INJ__.TEXT2 as string[])?.[0] ?? 'morphTo(shapeB)');
