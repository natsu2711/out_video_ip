// [outvideo] card-sc-particle-sand-fill —— 移植自 video-shotcraft/demos/data/particle-sand-fill
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: 110, width: '100%', textAlign: 'center' }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "PARTICLE SAND FILL")} size={72} />
      </div>
...
export default ParticleSandFill;
