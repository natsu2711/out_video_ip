// [outvideo] card-sc-color-block-step-wipe —— 移植自 video-shotcraft/demos/transition/color-block-step-wipe
...
import { G, Card } from './_sc/Fixtures';
...
const GrayPage: React.FC = () => (
  <AbsoluteFill style={{ background: G.panel, padding: '90px 160px', boxSizing: 'border-box' }}>
    ...
    <div style={{ display: 'flex', gap: 32, marginTop: 30 }}>
      <Card slot={0} w={420} h={280} seed={2} />
      <Card slot={1} w={420} h={280} seed={5} />
    </div>
  </AbsoluteFill>
);
  ...
  return (
    <AbsoluteFill>
      ...
      {p > 0 && (
        ...
        >
          <Card slot={2} w={420} h={290} seed={7} />
        </div>
      )}
    </AbsoluteFill>
  );
...
export default ColorBlockStepWipe;
