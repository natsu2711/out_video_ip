// [outvideo] card-sc-overhead-camera-moves —— 移植自 video-shotcraft/demos/camera/overhead-camera-moves
...
import { FakeDashboard, Card, G } from './_sc/Fixtures';
      ...
      <div style={{ position: 'absolute', inset: 0, perspective: 1600, perspectiveOrigin: '50% 42%' }}>
        ...
        >
          ...
          <PageCard x={PITCH}>
            ...
            >
              <Card slot={0} w={760} h={520} seed={4} />
            </div>
          </PageCard>
        </div>
      </div>
...
export default OverheadTabletopDrop;
