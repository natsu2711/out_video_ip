// [outvideo] card-sc-assemble-then-type-flyin —— 移植自 video-shotcraft/demos/effects/assemble-then-type-flyin
...
const MONO2 = ((__INJ__.TEXT as string[])?.[0] ?? "'SF Mono',Menlo,Consolas,monospace");
const SERIF2 = ((__INJ__.TEXT2 as string[])?.[0] ?? "Georgia,'Times New Roman',serif");
...
export default AssembleThenTypeFlyin;
