// [outvideo] card-sc-brace-expand —— 移植自 video-shotcraft/demos/typography/brace-expand
...
const FONT = ((__INJ__.TEXT as string[])?.[0] ?? '-apple-system,system-ui,sans-serif');
