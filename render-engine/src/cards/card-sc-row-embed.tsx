// [outvideo] card-sc-row-embed —— 移植自 video-shotcraft/demos/ui-entrance/row-embed
...
const detailSrc = staticFile(String(((__INJ__.CONFIG as any)?.image_1) ?? 'textures/live/detail-full.png'));
