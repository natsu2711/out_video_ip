// [outvideo] card-sc-stroke-segment-build —— 移植自 video-shotcraft/demos/opening/stroke-segment-build
...
export const StrokeSegmentBuild: React.FC = () => {
  ...
  const HEADING = ((__INJ__.TEXT as string[])?.[0] ?? 'STROKE SEGMENT BUILD');
...
export default StrokeSegmentBuild;
