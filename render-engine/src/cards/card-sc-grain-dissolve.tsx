// [outvideo] card-sc-grain-dissolve —— 移植自 video-shotcraft/demos/outro/grain-dissolve
...
import { E, DesignStage, seg, useT } from './_sc/Motion';

const __INJ__: any = (globalThis as any).__OUTVIDEO_CARD__ ?? {};
const TXT_LINE = ((__INJ__.TEXT as string[])?.[0] ?? '{ ACME. Now Live }');
const TXT_MARK = ((__INJ__.TEXT2 as string[])?.[0] ?? 'ACME');
