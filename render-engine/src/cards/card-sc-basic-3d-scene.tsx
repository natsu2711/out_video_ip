// [outvideo] card-sc-basic-3d-scene —— 移植自 video-shotcraft/demos/camera/basic-3d-scene
...
const TITLES = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['STEP 01', 'STEP 02', 'STEP 03', 'OVERVIEW']);
const SUBS = ((__INJ__.TEXT2 as string[])?.length ? (__INJ__.TEXT2 as string[]) : ['Position the idea', 'Rotate the view', 'Spin the frame', 'See everything']);

// 每个 step：位置 + 姿态 + 缩放（相机将取其逆）
const POSES = [
  { x: 0,   y: 0,   z: 0,    rx: 0, ry: 0,   rz: 0,  s: 1,   hue: 215, tt: TITLES[0],  sub: SUBS[0] },
  { x: 520, y: -60, z: -180, rx: 0, ry: -40, rz: 0,  s: 1,   hue: 265, tt: TITLES[1],  sub: SUBS[1] },
  { x: 160, y: 300, z: -520, rx: 0, ry: 0,   rz: 90, s: 1,   hue: 165, tt: TITLES[2],  sub: SUBS[2] },
  { x: 220, y: 90,  z: -260, rx: 0, ry: 0,   rz: 0,  s: 3.1, hue: 25,  tt: TITLES[3], sub: SUBS[3] },
];
