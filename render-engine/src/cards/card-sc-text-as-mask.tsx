// [outvideo] card-sc-text-as-mask —— 移植自 video-shotcraft/demos/opening/text-as-mask
...
import { FakeDashboard, G } from './_sc/Fixtures';

const MASK_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="1920" height="1080"><text x="960" y="666" font-family="Helvetica, Arial, sans-serif" font-size="360" font-weight="900" letter-spacing="-8" text-anchor="middle" fill="white">{((__INJ__.TEXT as string[])?.[0] ?? "SCALE")}/text></svg>`;
