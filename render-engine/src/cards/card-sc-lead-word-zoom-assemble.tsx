...
// [outvideo] card-sc-lead-word-zoom-assemble —— 移植自 video-shotcraft/demos/typography/lead-word-zoom-assemble
...
// ---- 编舞常量 ----
const TEXT = ((__INJ__.TEXT as string[])?.[0] ?? 'Introducing Lumen Deck');
const HIGHLIGHT_WORD = ((__INJ__.TEXT2 as string[])?.[0] ?? 'Lumen'); // 精确匹配的词换强调色：品牌词落位那一下自带高亮
const FONT_SIZE = 96;
...
const LETTER_SPACING = ((__INJ__.TEXT3 as string[])?.[0] ?? '-0.03em');
...
export default LeadWordZoomAssemble;
