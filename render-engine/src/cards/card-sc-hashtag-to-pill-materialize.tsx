// [outvideo] card-sc-hashtag-to-pill-materialize —— 移植自 video-shotcraft/demos/interaction/hashtag-to-pill-materialize
...
const Pill: React.FC<{ bg: string; iconColor: string; textColor: string }> = ({ bg, iconColor, textColor }) => (
  <div style={{
    ...
    <span style={{ fontSize: FS, fontWeight: 500, color: textColor, letterSpacing: 2 }}>{((__INJ__.TEXT as string[])?.[0] ?? "music")}</span>
  </div>
);
...
export default HashtagToPillMaterialize;
