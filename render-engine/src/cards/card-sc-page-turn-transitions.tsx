// [outvideo] card-sc-page-turn-transitions —— 移植自 video-shotcraft/demos/transition/page-turn-transitions
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 120, top: 60 }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "CUBE ROTATE")} size={54} />
      </div>
    </div>
  );
};
