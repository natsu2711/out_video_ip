// [outvideo] card-sc-transition-hidden-cut —— 移植自 video-shotcraft/demos/transition/transition-hidden-cut
// 原动效保留；内容接线：raw 档（可在编排手动用，后续逐张接 __INJ__）
import React from 'react';
const __INJ__: any = (globalThis as any).__OUTVIDEO_CARD__ ?? {};
import { AbsoluteFill, Easing, interpolate, useCurrentFrame } from 'remotion';
import { FakeDashboard, TitleBlock, G } from './_sc/Fixtures';
        ...
        {frame <= PEAK ? (
          ...
          <>
            ...
            <div style={{ position: 'absolute', left: 288, top: 132 }}>
              <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "Next Page")} size={64} />
            </div>
          </>
        )}
      </AbsoluteFill>
