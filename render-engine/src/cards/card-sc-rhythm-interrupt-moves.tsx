// [outvideo] card-sc-rhythm-interrupt-moves —— 移植自 video-shotcraft/demos/rhythm/rhythm-interrupt-moves
...
import { G, FakeDashboard, TitleBlock } from './_sc/Fixtures';
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', left: 260, top: 20 }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "STROBE BLACK FRAMES")} size={54} />
      </div>
...
export default StrobeBlackFrames;
