...
// [outvideo] card-sc-list-stack-press —— 移植自 video-shotcraft/demos/ui-entrance/list-stack-press
...
import layout from './_sc_assets/live-layout.json';
...
const FILES = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['paper1.png', 'paper2.png', 'paper3.png', 'paper4.png', 'paper5.png']) as string[];
