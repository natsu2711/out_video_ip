// [outvideo] card-sc-type-rhythm-sync —— 移植自 video-shotcraft/demos/typography/type-rhythm-sync
...
const TITLE = (__INJ__.TEXT as string[])?.[0] ?? 'PUMP IT UP';
