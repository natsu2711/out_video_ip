// [outvideo] card-sc-flying-words —— 移植自 video-shotcraft/demos/typography/flying-words
...
const WORDS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['Motion', 'Layout', 'Camera', 'Stagger', 'Easing', 'Beat', 'Keyframe', 'Blur',
