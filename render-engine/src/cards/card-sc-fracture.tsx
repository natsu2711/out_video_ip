// [outvideo] card-sc-fracture —— 移植自 video-shotcraft/demos/opening/fracture
...
import { DesignStage, E, rand, seg, useT } from './_sc/Motion';

export const FRACTURE_DURATION = 156; // 5200ms @30fps

const __INJ__: any = (globalThis as any).__OUTVIDEO_CARD__ ?? {};
const WORD = ((__INJ__.TEXT as string[])?.[0] ?? 'REASSEMBLE');
