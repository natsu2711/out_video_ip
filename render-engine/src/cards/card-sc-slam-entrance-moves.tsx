// [outvideo] card-sc-slam-entrance-moves —— 移植自 video-shotcraft/demos/effects/slam-entrance-moves
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'absolute', left: 120, top: 96 }}>
          <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "SCORE SLAM")} size={54} />
        </div>
