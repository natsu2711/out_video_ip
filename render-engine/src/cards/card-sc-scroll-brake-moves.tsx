// [outvideo] card-sc-scroll-brake-moves —— 移植自 video-shotcraft/demos/data/scroll-brake-moves
...
const TXT_TAG = ((__INJ__.TEXT as string[])?.[0] ?? 'v2.41');
...
export default BrakeReticleLock;
