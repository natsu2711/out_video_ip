...
// [outvideo] card-sc-document-typewriter-reveal —— 移植自 video-shotcraft/demos/ui-entrance/document-typewriter-reveal
...
const MONO = ((__INJ__.TEXT as string[])?.[0] ?? 'ui-monospace, SFMono-Regular, Menlo, monospace');
const PAPER = '#fdfcfa';
const AMBER = ((__INJ__.TEXT2 as string[])?.[0] ?? 'oklch(52% 0.115 65)');
const AMBER_WASH = ((__INJ__.TEXT3 as string[])?.[0] ?? 'oklch(95% 0.05 85)');
...
export default DocumentTypewriterReveal;
