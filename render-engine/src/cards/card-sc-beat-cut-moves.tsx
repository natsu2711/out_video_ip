// [outvideo] card-sc-beat-cut-moves —— 移植自 video-shotcraft/demos/rhythm/beat-cut-moves
...
const Footage: React.FC = () => (
  <div style={{ position: 'absolute', width: 1920, height: 1080 }}>
    ...
    <div style={{ position: 'absolute', left: 1070, top: 350, transform: 'translate(-50%, -50%)' }}>
      <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "84,213")} size={104} />
    </div>
  </div>
);
