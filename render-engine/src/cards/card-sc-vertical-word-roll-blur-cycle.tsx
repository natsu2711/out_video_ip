// [outvideo] card-sc-vertical-word-roll-blur-cycle —— 移植自 video-shotcraft/demos/typography/vertical-word-roll-blur-cycle
...
const ROW = 44;
const WORDS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['Apps', 'Teams', 'Data', 'Everyone']) as string[];
// 3 次换词，每次 0.11（≈0.55s）
...
export default VerticalWordRollBlurCycle;
