// [outvideo] card-sc-voice-waveform-live —— 移植自 video-shotcraft/demos/interaction/voice-waveform-live
...
const TXT_MIC = ((__INJ__.TEXT as string[])?.[0] ?? '🎙️');
...
export default VoiceWaveformLive;
