// [outvideo] card-sc-counter-confetti —— 移植自 video-shotcraft/demos/data/counter-confetti
...
const PAL = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['#ff6b8b', '#ffb347', '#ffe86b', '#7bff9e', '#5fd8ff', '#6c8cff', '#c86cff', '#ff6cf0']) as string[];
...
export default CounterConfetti;
