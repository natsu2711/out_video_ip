// [outvideo] card-sc-fui-hud-moves —— 移植自 video-shotcraft/demos/effects/fui-hud-moves
...
// 文字槽：TEXT = 咬合标签
const LABEL_TEXT = (__INJ__.TEXT as string[])?.[0] ?? 'TARGET · CARD_02';
