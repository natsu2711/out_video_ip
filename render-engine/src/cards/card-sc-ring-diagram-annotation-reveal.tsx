// [outvideo] card-sc-ring-diagram-annotation-reveal —— 移植自 video-shotcraft/demos/data/ring-diagram-annotation-reveal
...
import { DesignStage } from './_sc/Motion';

const __INJ__: any = (globalThis as any).__OUTVIDEO_CARD__ ?? {};
// TEXT = 注释栏主词条；TEXT2 = 次词条；TEXT3 = [环心外圈文字, 环心主体文字]
const TXT_EXPLANATION = ((__INJ__.TEXT as string[])?.[0] ?? 'EXPLANATION');
const TXT_DETAIL = ((__INJ__.TEXT2 as string[])?.[0] ?? 'SUPPORTING DETAIL');
const TXT_CONTENT = ((__INJ__.TEXT3 as string[])?.[0] ?? 'CONTENT');
const TXT_SUBJECT = ((__INJ__.TEXT3 as string[])?.[1] ?? 'SUBJECT');
...
export default RingDiagramAnnotationReveal;
