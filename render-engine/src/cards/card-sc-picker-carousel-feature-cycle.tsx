// [outvideo] card-sc-picker-carousel-feature-cycle —— 移植自 video-shotcraft/demos/interaction/picker-carousel-feature-cycle
...
const MID = '#8A8A8F';
const ROW_H = 34; // 单行高度
const ITEMS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['Data Cleanup',
  'Direct Message',
  'Smart Segments',
  'Batch Actions',
  'Reward Program',
  'Automated Flows',
  'Variant Testing',]) as string[];
const ICONS = ((__INJ__.TEXT2 as string[])?.length ? (__INJ__.TEXT2 as string[]) : ['◎', '✉', '◧', '◈', '★', '↺', '⚑']) as string[];
...
export default PickerCarouselFeatureCycle;
