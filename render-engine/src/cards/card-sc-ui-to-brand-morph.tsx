// [outvideo] card-sc-ui-to-brand-morph —— 移植自 video-shotcraft/demos/outro/ui-to-brand-morph
...
const TXT_MESSAGE = ((__INJ__.TEXT as string[])?.[0] ?? 'Ready, set, go!');
...
export default InputMorphsIntoLogo;
