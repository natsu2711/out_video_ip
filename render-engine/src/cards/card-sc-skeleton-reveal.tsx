// [outvideo] card-sc-skeleton-reveal —— 移植自 video-shotcraft/demos/ui-entrance/skeleton-reveal
...
// ——— 骨架/内容消息行 ———
const NAMES = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['Ana', 'Ben', 'Kai', 'Mia']) as string[];
const AVA = ((__INJ__.TEXT2 as string[])?.length ? (__INJ__.TEXT2 as string[]) : ['#5a5a58', '#7a7a78', '#4a4a48', '#8f8f8d']) as string[];
const MSGS = [
