// [outvideo] card-sc-quad-split-parallel-scenes —— 移植自 video-shotcraft/demos/rhythm/quad-split-parallel-scenes
...
const BGS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['#c3c6cc', '#f2f1ef', '#e7e6e3', '#b8bcc3']) as string[];
const TRAFFIC = ((__INJ__.TEXT2 as string[])?.length ? (__INJ__.TEXT2 as string[]) : ['#ff5f57', '#febc2e', '#28c840']) as string[];
const TABNAMES = ((__INJ__.TEXT3 as string[])?.length ? (__INJ__.TEXT3 as string[]) : ['Tab One', 'Tab Two', 'Tab Three', 'Tab Four', 'Tab Five', 'Tab Six']) as string[];
...
export default QuadSplitParallelScenes;
