// [outvideo] card-sc-title-demote-to-label —— 移植自 video-shotcraft/demos/typography/title-demote-to-label
...
import { G } from './_sc/Fixtures';

const FONT = ((__INJ__.TEXT as string[])?.[0] ?? 'Helvetica, Arial, sans-serif');
const SEL = ((__INJ__.TEXT2 as string[])?.[0] ?? 'rgba(58, 128, 236, 0.35)');
...
export default TitleDemoteToLabel;
