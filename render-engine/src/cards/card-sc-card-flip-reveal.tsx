// [outvideo] card-sc-card-flip-reveal —— 移植自 video-shotcraft/demos/transition/card-flip-reveal
...
const RESULTS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['4.9×', '−38%', '99.9%']) as string[];
    ...
    >
      ...
      >
        ...
        <div style={{ position: 'absolute', inset: 0, backfaceVisibility: 'hidden' }}>
          <Card slot={0} w={CW} h={CH} seed={i + 1} />
          <Sheen angle={angle} />
        </div>
