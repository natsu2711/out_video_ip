// [outvideo] card-sc-riso-print-hits —— 移植自 video-shotcraft/demos/effects/riso-print-hits
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Card slot={0} w={330} h={200} seed={2} />
          <Card slot={1} w={330} h={200} seed={5} />
          <Card slot={2} w={330} h={200} seed={8} />
        </div>
