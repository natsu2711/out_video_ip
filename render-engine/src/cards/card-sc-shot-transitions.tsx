...
// [outvideo] card-sc-shot-transitions —— 移植自 video-shotcraft/demos/transition/shot-transitions
...
const PAPER_LIGHT = ((__INJ__.TEXT3 as string[])?.[0] ?? 'oklch(92% 0.01 82)');
...
export default BlackCardTransition;
