...
// [outvideo] card-sc-line-boil —— 移植自 video-shotcraft/demos/effects/line-boil
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', left: 120, top: 96 }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "LINE BOIL")} size={54} />
      </div>
