// [outvideo] card-sc-line-carry-transition —— 移植自 video-shotcraft/demos/transition/line-carry-transition
  ...
  return (
    <AbsoluteFill style={{ background: G.bg, overflow: 'hidden' }}>
      ...
      >
        ...
        <Card slot={0} w={560} h={330} seed={2} style={{ position: 'absolute', left: 400, top: 350 }} />
...
export default LineCarryTransition;
