// [outvideo] card-sc-tension-camera-moves —— 移植自 video-shotcraft/demos/camera/tension-camera-moves
  ...
  return (
    ...
    >
      <div style={{ position: 'absolute', top: 56, left: 72 }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "BULLET TIME")} size={44} />
      </div>
...
export default BulletTimeFreezeOrbit;
