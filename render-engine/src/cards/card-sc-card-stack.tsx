// [outvideo] card-sc-card-stack —— 移植自 video-shotcraft/demos/ui-entrance/card-stack
...
const GLYPHS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['◆', '●', '▲', '■', '✦', '◐', '◇', '○']) as string[];
