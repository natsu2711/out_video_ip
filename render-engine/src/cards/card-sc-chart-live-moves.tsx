// [outvideo] card-sc-chart-live-moves —— 移植自 video-shotcraft/demos/data/chart-live-moves
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: 100, width: '100%', textAlign: 'center' }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "AXIS RESCALE SHOCK V2")} size={72} />
      </div>
...
export default AxisRescaleShockV2;
