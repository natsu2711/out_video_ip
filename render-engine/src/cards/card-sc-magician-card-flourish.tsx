// [outvideo] card-sc-magician-card-flourish —— 移植自 video-shotcraft/demos/opening/magician-card-flourish
...
const G_INJ: any = (globalThis as any).__OUTVIDEO_CARD__ ?? {};
const FACE_IMAGE = (G_INJ.CONFIG as any)?.image_1;
...
export default MagicianCardFlourish;
