// [outvideo] card-sc-letterspace-materialize —— 移植自 video-shotcraft/demos/opening/letterspace-materialize
...
const WORD = ((__INJ__.TEXT as string[])?.[0] ?? 'SUPERHUMAN');
...
export default LetterspaceMaterialize;
