// [outvideo] card-sc-type-entrance-moves —— 移植自 video-shotcraft/demos/typography/type-entrance-moves
...
const WORD = ((__INJ__.TEXT as string[])?.[0] ?? 'GRAVITY');
...
export default LetterDropPhysics;
