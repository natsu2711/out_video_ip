// [outvideo] card-sc-hatch-depth —— 移植自 video-shotcraft/demos/data/hatch-depth
  ...
  return (
    <DesignStage bg="#0a0a0c">
      ...
      >
        ...
        >
          <span style={{ color: '#e8eaf0', fontWeight: 700 }}>{((__INJ__.TEXT2 as string[])?.[1] ?? "METRICS")}</span>
          {NBSP2}
          <span style={{ color: '#67d17c' }}>{((__INJ__.TEXT as string[])?.[0] ?? "● LIVE")}</span>
          {NBSP2}
