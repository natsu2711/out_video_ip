// [outvideo] card-sc-white-flash-logo-simplify-cut —— 移植自 video-shotcraft/demos/transition/white-flash-logo-simplify-cut
...
const GRAD_B = '#5a6cf5';
const GRAD_C = '#22c4e8';
const WORDMARK = ((__INJ__.TEXT as string[])?.[0] ?? 'BRAND');
...
export default WhiteFlashLogoSimplifyCut;
