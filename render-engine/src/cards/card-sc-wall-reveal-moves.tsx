// [outvideo] card-sc-wall-reveal-moves —— 移植自 video-shotcraft/demos/ui-entrance/wall-reveal-moves
          ...
          return (
            <div key={i} style={{ width: CELL_W, height: CELL_H, position: 'relative' }}>
              ...
              >
                ...
                >
                  <Card slot={0} w={CELL_W} h={CELL_H} seed={i + 1} style={{ width: '100%', height: '100%' }} />
                </div>
              </div>
