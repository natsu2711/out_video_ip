// [outvideo] card-sc-bezier-source-converge-merge —— 移植自 video-shotcraft/demos/ui-entrance/bezier-source-converge-merge
...
const ACCENT = '#3B82F6';
const ACCENT_WASH = ((__INJ__.TEXT as string[])?.[0] ?? 'rgba(59,130,246,.12)');
...
const CAP_WORDS = (((__INJ__.TEXT2 as string[])?.[0] ?? 'Four sources unified').split(' '));
...
export default BezierSourceConvergeMerge;
