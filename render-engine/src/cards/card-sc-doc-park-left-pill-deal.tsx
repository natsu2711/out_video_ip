// [outvideo] card-sc-doc-park-left-pill-deal —— 移植自 video-shotcraft/demos/ui-entrance/doc-park-left-pill-deal
...
const INJ = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['Quick Start', 'Bundle Plan', 'Starter Kit']);
const CAPS = ((__INJ__.TEXT2 as string[])?.length ? (__INJ__.TEXT2 as string[]) : ['Start matches their preference', 'Plan fits their weekday usage', 'Kit is their top repeat item']);

const ITEMS: { n: string; ic: 'leaf' | 'bowl' | 'wrap'; cap: string }[] = [
  { n: INJ[0], ic: 'leaf', cap: CAPS[0] },
  { n: INJ[1], ic: 'bowl', cap: CAPS[1] },
  { n: INJ[2], ic: 'wrap', cap: CAPS[2] },
];
...
export default DocParkLeftPillDeal;
