// [outvideo] card-sc-canvas-materialize-moves —— 移植自 video-shotcraft/demos/interaction/canvas-materialize-moves
...
const TXT_BUTTON = ((__INJ__.TEXT as string[])?.[0] ?? 'Add all to canvas');
...
export default PanelToCanvasMaterialize;
