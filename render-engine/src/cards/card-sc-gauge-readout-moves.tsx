// [outvideo] card-sc-gauge-readout-moves —— 移植自 video-shotcraft/demos/data/gauge-readout-moves
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: 110, width: '100%', textAlign: 'center' }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "NEEDLE SWEEP SELF-TEST")} size={72} />
      </div>
      <div style={{
...
export default NeedleSweepSelftest;
