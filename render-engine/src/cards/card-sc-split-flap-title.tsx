// [outvideo] card-sc-split-flap-title —— 移植自 video-shotcraft/demos/typography/split-flap-title
...
const TEXT = ((__INJ__.TEXT as string[])?.[0] ?? 'SHIP FASTER');
const CHARSET = ((__INJ__.TEXT2 as string[])?.[0] ?? 'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789#$%&');
