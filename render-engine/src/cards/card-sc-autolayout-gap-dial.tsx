// [outvideo] card-sc-autolayout-gap-dial —— 移植自 video-shotcraft/demos/interaction/autolayout-gap-dial
...
const TXT_TITLE = ((__INJ__.TEXT as string[])?.[0] ?? 'GAP');
...
export default AutolayoutGapDial;
