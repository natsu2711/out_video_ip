// [outvideo] card-sc-icon-field-colorize —— 移植自 video-shotcraft/demos/opening/icon-field-colorize
...
const GRAYS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['#9a9a9a', '#7c7c7c', '#b0b0b0', '#8b8b8b']) as string[];
...
export default IconFieldColorize;
