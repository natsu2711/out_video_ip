// [outvideo] card-sc-avatar-bracket-carousel —— 移植自 video-shotcraft/demos/ui-entrance/avatar-bracket-carousel
...
const CORNERS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['M4,26 L4,4 L26,4', 'M66,4 L88,4 L88,26', 'M88,66 L88,88 L66,88', 'M26,88 L4,88 L4,66']) as string[];
...
export default AvatarBracketCarousel;
