// [outvideo] card-sc-panel-grid-moves —— 移植自 video-shotcraft/demos/rhythm/panel-grid-moves
...
// 文字槽：TEXT = KPI 数字
const KPI_VALUE = (__INJ__.TEXT as string[])?.[0] ?? '1,284';
...
export default ComicPanelSplit;
