// [outvideo] card-sc-scanline-assemble-flyin —— 移植自 video-shotcraft/demos/effects/scanline-assemble-flyin
    ...
    <DesignStage bg="#0a0b0e">
      ...
      <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg,#0f1114,#0a0c10)' }}>
        ...
        <div style={{ ...fly(PLAN[3]), left: 22, top: 64, width: 242, height: 84 }}>
          <div style={{ position: 'absolute', left: 0, top: 0, font: `400 29px ${SERIF}`, color: '#f2f3f6', letterSpacing: 0.3 }}>{((__INJ__.TEXT as string[])?.[0] ?? "The headline for")}</div>
...
export default ScanlineAssembleFlyin;
