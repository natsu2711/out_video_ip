// [outvideo] card-sc-word-relay-filmstrip —— 移植自 video-shotcraft/demos/typography/word-relay-filmstrip
...
const WORDS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['researches', 'builds', 'codes']) as string[];
...
export default WordRelayFilmstrip;
