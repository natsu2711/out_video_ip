...
// [outvideo] card-sc-chip-grid-single-select-blackout —— 移植自 video-shotcraft/demos/interaction/chip-grid-single-select-blackout
...
const CAP_TEXT = ((__INJ__.TEXT as string[])?.[0] ?? '18% off  ·  42.00  →  34.44');
...
export default ChipGridSingleSelectBlackout;
