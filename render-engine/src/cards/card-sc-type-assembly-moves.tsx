// [outvideo] card-sc-type-assembly-moves —— 移植自 video-shotcraft/demos/typography/type-assembly-moves
...
const WORD = ((__INJ__.TEXT as string[])?.[0] ?? 'ASSEMBLE');
...
export default LetterformDriftAssembly;
