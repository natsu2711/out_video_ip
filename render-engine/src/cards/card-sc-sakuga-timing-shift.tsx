// [outvideo] card-sc-sakuga-timing-shift —— 移植自 video-shotcraft/demos/rhythm/sakuga-timing-shift
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: G.bg, position: 'relative', overflow: 'hidden' }}>
      ...
      {ghosts.map((g, i) => (
        ...
        >
          <Card slot={0} w={CARD_W} h={CARD_H} seed={4} />
        </div>
      ))}
      ...
      >
        <Card slot={1} w={CARD_W} h={CARD_H} seed={4} />
      </div>
...
export default SakugaTimingShift;
