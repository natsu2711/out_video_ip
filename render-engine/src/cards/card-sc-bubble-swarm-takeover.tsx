// [outvideo] card-sc-bubble-swarm-takeover —— 移植自 video-shotcraft/demos/transition/bubble-swarm-takeover
...
import { FakeDashboard } from './_sc/Fixtures';
...
const CAPSULES = [
  { text: ((__INJ__.TEXT as string[])?.[2] ?? 'Hallo!'), idx: 5 },
  { text: ((__INJ__.TEXT as string[])?.[1] ?? '¡Hola!'), idx: 14 },
  { text: ((__INJ__.TEXT as string[])?.[0] ?? 'Ciao!'), idx: 23 },
];
...
export default BubbleSwarmTakeover;
