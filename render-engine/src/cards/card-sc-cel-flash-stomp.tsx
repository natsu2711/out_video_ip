// [outvideo] card-sc-cel-flash-stomp —— 移植自 video-shotcraft/demos/typography/cel-flash-stomp
  ...
  return (
    <div style={{ width: 1920, height: 1080, background: bg, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', left: 120, top: 96 }}>
        <TitleBlock text={((__INJ__.TEXT as string[])?.[0] ?? "CEL FLASH STOMP")} size={54} />
      </div>
