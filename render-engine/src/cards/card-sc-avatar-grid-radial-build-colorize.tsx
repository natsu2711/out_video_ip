// [outvideo] card-sc-avatar-grid-radial-build-colorize —— 移植自 video-shotcraft/demos/data/avatar-grid-radial-build-colorize
...
const ICONS = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['◆', '▲', '●', '■', '✦', '◐', '❖', '▣']) as string[];
...
export default AvatarGridRadialBuildColorize;
