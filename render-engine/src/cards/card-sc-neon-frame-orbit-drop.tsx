...
// [outvideo] card-sc-neon-frame-orbit-drop —— 移植自 video-shotcraft/demos/ui-entrance/neon-frame-orbit-drop
...
const HUES = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['#b06af0', '#e879c9', '#f0a35c', '#6a7df0', '#e0679a', '#8a5cf0', '#c06af0']) as string[];
...
export default NeonFrameForerunOrbit;
