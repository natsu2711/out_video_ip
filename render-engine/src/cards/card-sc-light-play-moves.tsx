// [outvideo] card-sc-light-play-moves —— 移植自 video-shotcraft/demos/effects/light-play-moves
...
const TEXT_MAIN = ((__INJ__.TEXT as string[])?.[0] ?? '10x');
const TEXT_LABEL = ((__INJ__.TEXT2 as string[])?.[0] ?? 'HALATION BLOOM');
