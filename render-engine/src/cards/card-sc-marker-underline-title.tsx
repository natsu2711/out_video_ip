...
// [outvideo] card-sc-marker-underline-title —— 移植自 video-shotcraft/demos/typography/marker-underline-title
  ...
  return (
    <AbsoluteFill style={{ background: '#f4f4f2', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{
        ...
        <div>{((__INJ__.TEXT as string[])?.[0] ?? "Notion AI")}</div>
      </div>
    </AbsoluteFill>
  );
};
...
export default MarkerUnderlineTitle;
