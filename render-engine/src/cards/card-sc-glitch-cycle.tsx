// [outvideo] card-sc-glitch-cycle —— 移植自 video-shotcraft/demos/typography/glitch-cycle
...
import { DesignStage, lerp, rand, useT } from './_sc/Motion';

export const GLITCH_CYCLE_DURATION = 168; // 5600ms @30fps

const PHRASES = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['INITIALIZING', 'LOADING ASSETS', 'COMPILING SHADERS', 'READY TO SHIP']) as string[];
