// [outvideo] card-sc-aurora-bloom-bg-flip —— 移植自 video-shotcraft/demos/effects/aurora-bloom-bg-flip
...
const WA = (((__INJ__.TEXT as string[])?.[0] ?? 'For many years').split(' '));
const WB = (((__INJ__.TEXT2 as string[])?.[0] ?? 'everything changed').split(' '));

const FONT = ((__INJ__.TEXT3 as string[])?.[0] ?? '600 26px -apple-system,system-ui,sans-serif');
...
export default AuroraBloomBgFlip;
