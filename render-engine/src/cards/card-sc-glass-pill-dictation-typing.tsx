...
// [outvideo] card-sc-glass-pill-dictation-typing —— 移植自 video-shotcraft/demos/interaction/glass-pill-dictation-typing
...
const UI = ((__INJ__.TEXT as string[])?.[0] ?? '-apple-system,system-ui,"Segoe UI",sans-serif');
const PH = 46; // 胶囊高度
const ICON = 30; // 右端声波图标方块尺寸
const BASE = [13, 7, 10, 6, 9]; // 竖条基准高度（左高右低的听写图标）
const TEXT = ((__INJ__.TEXT2 as string[])?.[0] ?? 'Speak or type here'); // 占位句，长度贴近原片（19→18 字符），打字节奏不变
...
export default GlassPillDictationTyping;
