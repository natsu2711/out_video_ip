// [outvideo] card-sc-terminal-3d —— 移植自 video-shotcraft/demos/camera/terminal-3d
...
const PK = ((__INJ__.TEXT as string[])?.length ? (__INJ__.TEXT as string[]) : ['x', 'y', 'z', 'ry']) as string[];
