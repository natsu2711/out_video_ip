// [outvideo] card-sc-spectrum-morph-ui —— 移植自 video-shotcraft/demos/rhythm/spectrum-morph-ui
...
// 文字槽：TEXT = 标题
const TITLE = (__INJ__.TEXT as string[])?.[0] ?? 'LAUNCH WEEK';
...
export default SpectrumMorphUi;
