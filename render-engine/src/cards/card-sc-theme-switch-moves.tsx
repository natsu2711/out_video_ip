// [outvideo] card-sc-theme-switch-moves —— 移植自 video-shotcraft/demos/interaction/theme-switch-moves
      ...
      {panelMounted && (
        ...
        >
          ...
          <div style={{ height: 62, border: `2px solid ${G.line}`, borderRadius: 12, display: 'flex', alignItems: 'center', gap: 14, padding: '0 18px', boxSizing: 'border-box' }}>
            <div style={{ padding: '6px 12px', borderRadius: 8, background: G.side, color: '#fff', fontFamily: 'Helvetica, Arial, sans-serif', fontWeight: 800, fontSize: 22 }}>{((__INJ__.TEXT as string[])?.[0] ?? "⌘K")}</div>
            {TYPE_FRAMES.map((_, i) => (
...
export default PaletteThemeRipple;
