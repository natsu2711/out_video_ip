// [outvideo] card-sc-edit-hook-moves —— 移植自 video-shotcraft/demos/outro/edit-hook-moves
...
const TXT_LOGO = ((__INJ__.TEXT as string[])?.[0] ?? 'ACME');
...
export default LogoStingButton;
