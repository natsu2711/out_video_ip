// [outvideo] card-sc-chip-lift-to-user-pill —— 移植自 video-shotcraft/demos/interaction/chip-lift-to-user-pill
...
const NAME_CHARS = (((__INJ__.TEXT as string[])?.[0] ?? 'Casey Doe').split('')); // 药丸内逐字打出的人名

// 结尾字幕（逐词加深语法，只用到 show + inn 两态）
const CAP_WORDS = (((__INJ__.TEXT2 as string[])?.[0] ?? 'Starting with Casey').split(' '));
...
export default ChipLiftToUserPill;
