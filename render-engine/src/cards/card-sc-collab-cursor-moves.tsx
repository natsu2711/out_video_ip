// [outvideo] card-sc-collab-cursor-moves —— 移植自 video-shotcraft/demos/interaction/collab-cursor-moves
...
const TYPED = ((__INJ__.TEXT as string[])?.[0] ?? 'Our customers love it');
...
export default CursorCastEnsemble;
