// [outvideo] card-sc-morph-from-primitive —— 移植自 video-shotcraft/demos/ui-entrance/morph-from-primitive
...
const CARD_IMG = (__INJ__.CONFIG as any)?.image_1 ? String((__INJ__.CONFIG as any).image_1) : null;
...
export default MorphFromPrimitive;
